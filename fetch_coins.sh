...
curl -l "https://raw.githubusercontent.com/zdeex/coins-ce/${coins_repo_commit}/coins" --output "assets/coins.json"
curl -l "https://raw.githubusercontent.com/zdeex/coins-ce/${coins_repo_commit}/utils/coins_config_tcp.json" --output "assets/coins_config_tcp.json"
